...
const Home = () => {
    ...
    return (
        <PageTransition>
            ...
            <section ref={heroRef} className="relative h-screen flex items-center justify-center bg-black overflow-hidden perspective-1000">
                ...
                <motion.div style={{ opacity: opacityHero }} className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <Link to="/reserver-un-vol" className="px-8 py-4 border border-white/20 text-white uppercase tracking-widest hover:border-violet-500 hover:text-violet-400 transition-colors flex items-center gap-2">
                            {t('hero.primary_cta')}
            ...
            {/* Pricing Section - Nos Formules */}
            <section className="py-24 bg-zinc-950 border-t border-white/5 relative overflow-hidden">
                {/* Background decoration */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-violet-600/5 blur-[120px] rounded-full pointer-events-none"></div>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="text-center mb-20">
                        <motion.span
                            ...
                            className="text-violet-400 font-bold tracking-[0.3em] uppercase text-sm mb-4 block"
                        >
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch max-w-7xl mx-auto">
                        ...
                        >
                            <div className="w-12 h-12 bg-violet-500/10 flex items-center justify-center rounded-xl mb-8 group-hover:scale-110 transition-transform">
                        ...
                        <motion.div
                            ...
                            className="bg-zinc-950 border-2 border-violet-500 p-8 flex flex-col shadow-[0_0_40px_rgba(139,92,246,0.1)] relative scale-105 z-10"
                        >
                            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-violet-600 text-white text-[10px] font-black uppercase px-4 py-1.5 tracking-[0.2em] whitespace-nowrap">
                                {t('formation.pricing.dedicated')}
                            </div>
                            <div className="w-12 h-12 bg-violet-500 flex items-center justify-center rounded-xl mb-8 shadow-lg shadow-violet-500/20">
                            ...
                            <div className="mt-auto pt-6 border-t border-violet-500/30">
